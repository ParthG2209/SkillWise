...
// CounterElement is just an HTMLElement - use HTMLElement directly
...
// FAQItemComponents holds references to FAQ item DOM elements
...
export interface CoreModuleExports {
    ...
    readonly showAndHidePopUp: (
        selector: string,
        delayShow?: number,
        delayHide?: number,
        showTranslate?: string,
        hideTranslate?: string
    ) => void;
}
